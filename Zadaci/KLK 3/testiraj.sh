...
OUTP03=$(cat <<EOL
Unesite tekst:	+12345678abcdk!5z
Greska: Prekoracenje
EOL
)
...
OUTP04=$(cat <<EOL
Unesite tekst:	+5k!8bz12
Greska: Ima vise od 2 heks broja
EOL
)
...
OUTP05=$(cat <<EOL
Unesite tekst:	+ff0fffffk00f00000
Greska: Prekoracenje
EOL
)
